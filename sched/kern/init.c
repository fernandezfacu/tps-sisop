...
#define TESTED(x) (__builtin_strcmp(#x, STRING(TEST)) == 0)
	...
	// ENV_CREATE(user_idle100000, ENV_TYPE_USER);

	// ENV_CREATE(user_yield, ENV_TYPE_USER);

	// ENV_CREATE(user_getprio, ENV_TYPE_USER);

	// ENV_CREATE(user_reduceprio, ENV_TYPE_USER);

	// ENV_CREATE(user_faultreduceprio, ENV_TYPE_USER);

	// ENV_CREATE(user_forkprios, ENV_TYPE_USER);
